<x-app-layout>
    ...
    <section class="text-gray-600 body-font max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="container px-2 py-8 mx-auto bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <a class="inline-flex items-center mb-4 h-8 px-4 m-1 text-sm text-white transition-colors duration-150 bg-black rounded-lg focus:shadow-outline hover:bg-red-800" href="{{route('myposts.create')}}">Crear</a>
              ...
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                  ...
                  <div class="flex items-center flex-wrap ">
                    <a class="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0" href="{{route('myposts.show',$item->id)}}">Ver más
